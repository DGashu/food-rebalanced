...
public class FoodConfigManager {
    ...
    private static void createDefaultConfig() throws IOException {
        ...
        JsonArray 
            stewEffects = effects(createEffect("minecraft:regeneration", 200, 0, 1.0f)), 
        ...
        food(root, "minecraft:mushroom_stew",
            createFood(true, 6, 0.5f, true, 32, stewEffects, null));

        food(root, "minecraft:cookie",
            createFood(false, 2, 0.2f, null, 8, cookieEffects, null));

        food(root, "minecraft:pumpkin_pie",
            createFood(true, 8, 0.8f, null, 28, pumpkinPieEffects, null));

        food(root, "minecraft:golden_carrot",
            createFood(true, 6, 0.8f, null, 28, goldenCarrotEffects, null));
        
        food(root, "minecraft:glow_berries",
            createFood(false, 2, 0.2f, null, 10, glowBerryEffects, null));

        food(root, "minecraft:pufferfish",
            createFood(false, 1, 0.1f, null, 20, pufferfishEffects, null));
        ...
        food(root, "minecraft:dried_kelp",
            createFood(false, 1, 0.2f, null, 10, null, driedKelpRemoveEffects));
        ...
        food(root, "minecraft:sweet_berries",
            createFood(true, 2, 0.2f, null, 10, null, null));
